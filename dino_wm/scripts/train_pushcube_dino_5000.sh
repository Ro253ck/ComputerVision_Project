#!/bin/bash
#SBATCH --job-name=dinowm_train_dino_pushcube_5000
...
#SBATCH --output=/work/cvcs2026/LubiMoRe/logs/train_dino_pushcube_5000_%j.out
#SBATCH --error=/work/cvcs2026/LubiMoRe/logs/train_dino_pushcube_5000_%j.err
